                          ...
                          <div className="col-span-4 md:col-span-2">
                            ...
                            <div className="flex items-center gap-2">
                              <select
                                ...
                                className="w-20 border border-slate-200 rounded-lg px-2 py-2 text-sm focus:ring-2 focus:ring-slate-100 focus:border-slate-400"
                              >
                              ...
                              <input
                                ...
                                className="border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-slate-100 focus:border-slate-400 w-full text-right tabular-nums"
                              />
                            </div>
                          </div>
                      ...
                      <>
                        ...
                        {totalDiscount > 0 && (
                          <div className="flex justify-between items-center text-sm text-slate-600">
                            <span>Discounts</span>
                            <span className="font-medium text-rose-600">−{currency}{totalDiscount.toFixed(2)}</span>
                          </div>
                        )}
                        {applyTaxes && (() => {
