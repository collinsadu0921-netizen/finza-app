...
export default function RetailCustomerProfilePage() {
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <Link
            href={`/retail/customers/${customerId}/edit`}
            ...
            {layawayPlans.map((plan) => (
              <div key={plan.id} className="border border-gray-200 rounded-lg p-4 bg-orange-50">
                ...
                <div className="mt-3 pt-3 border-t">
                  <Link href={`/retail/sales-history/${plan.sale_id}/receipt`} className="text-blue-600 hover:text-blue-800 text-sm">
                    View Sale Receipt →
                  </Link>
                </div>
              </div>
              ...
              <tbody>
                {sales.map((sale) => (
                  <tr key={sale.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-2">
                      <Link href={`/retail/sales-history/${sale.id}/receipt`} className="text-blue-600 hover:text-blue-800 text-sm">
                        View Receipt
                      </Link>
                    </td>
                  </tr>
