                ...
                {customers.map((customer) => (
                  <tr key={customer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <Link href={`/service/customers/${customer.id}`} className="text-blue-600 hover:text-blue-900 mr-4">
                        View
                      </Link>
                      <Link href={`/service/customers/${customer.id}/statement`} className="text-green-600 hover:text-green-900">
                        Statement
                      </Link>
                    </td>
                  </tr>
