  ...
  const handleWhatsApp = async () => {
    try {
      ...
      if (!phone) {
        ...
        setToast({
          message:
            "Opened WhatsApp with message only. Add a mobile or WhatsApp number on the customer to open their chat directly.",
          type: "info",
        })
        return
      }
              ...
              {proforma?.status === "draft" && proforma?.customers?.name && (
                <div className="bg-slate-50 rounded-xl px-4 py-3 text-sm mb-2">
                  ...
                  >
                    ...
                    {proforma?.status === "draft" ? "Send via WhatsApp" : "Send via WhatsApp again"}
                  ...
                  >
                    ...
                    {proforma?.status === "draft" ? "Send via Email" : "Send via email again"}
