-- ============================================================================
-- MIGRATION: Set posting_source on manual_draft journal_entries INSERT
-- ============================================================================
-- journal_entries.posting_source is NOT NULL and has no default (190).
-- post_manual_journal_draft_to_ledger omitted it; this migration adds
-- posting_source = 'system' (avoids accountant trigger; owner/firm auth is in RPC). No other changes.
-- ============================================================================
