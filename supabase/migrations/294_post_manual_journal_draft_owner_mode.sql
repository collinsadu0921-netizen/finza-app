-- ============================================================================
-- MIGRATION: post_manual_journal_draft_to_ledger — Owner-Mode Support
-- ============================================================================
-- Replaces function from 148_manual_journal_draft_posting_hardening.sql.
-- Supports owner-mode drafts (accounting_firm_id IS NULL) without changing
-- firm-mode behavior, period lock, idempotency, or journal_entries schema.
-- ============================================================================
