-- ============================================================================
-- Migration 551: Neutral sales revenue journal line wording
-- ============================================================================
-- Future invoice postings use "Sales revenue" on account 4000 line descriptions.
-- Account code, amounts, and tax calculations are unchanged.
-- Historical journal_entry_lines keep their stored "Service revenue" text.
-- ============================================================================
...
Revenue line description: Sales revenue (neutral label for services and material sales on 4000).
...
Migration history: 355 (FX) → 379 (rounding) → 492 (issue_date) → 551 (Sales revenue wording).';
