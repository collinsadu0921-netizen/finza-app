-- Migration 532: Correct Phase 1B SQL test — post all required depreciation through disposal month
...
BEGIN
  ...
  -- Cash disposal with gain (after depreciation through disposal month)
  INSERT INTO assets (
  ...
  PERFORM post_asset_depreciation(v_asset_id, '2026-01-01'::date, NULL, NULL, 'p1b-dep-' || v_asset_id::text || '-jan', v_owner_id);
  PERFORM post_asset_depreciation(v_asset_id, '2026-02-01'::date, NULL, NULL, 'p1b-dep-' || v_asset_id::text || '-feb', v_owner_id);
