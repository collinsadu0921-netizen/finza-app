-- ============================================================================
-- MIGRATION: Final fix for payment ledger balance issue
-- ============================================================================
-- This migration ensures:
-- 1. post_payment_to_ledger uses payment_amount correctly
-- 2. trigger_post_payment has exception handling to prevent rollback
-- ============================================================================

-- First, fix the trigger to be resilient (Migration 073 - but ensure it's applied)
...
-- Now, ensure post_payment_to_ledger uses payment_amount correctly (Migration 072 - ensure it's applied)
...
BEGIN
  ...
  -- IMPORTANT: Use payment_amount for BOTH debit and credit, NOT invoice.total
  SELECT post_journal_entry(
    ...
    jsonb_build_array(
      ...
      jsonb_build_object(
        ...
        'credit', payment_amount,  -- MUST use payment_amount, NOT invoice.total
