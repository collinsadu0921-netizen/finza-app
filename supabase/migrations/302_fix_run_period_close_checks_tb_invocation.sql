-- Fix forward: run_period_close_checks called get_trial_balance_from_snapshot with
-- a redundant column definition list. get_trial_balance_from_snapshot already
-- returns TABLE(...). Use FROM get_trial_balance_from_snapshot(p_period_id) AS tb.
