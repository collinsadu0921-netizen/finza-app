-- Complete Schema Update - Run this in Supabase SQL Editor
-- This consolidates all migrations and fixes duplicate/conflicting statements

-- ============================================
-- INVENTORY MANAGEMENT
-- ============================================

-- Add inventory fields to products table (only once)
...
-- Drop existing policies if they exist (fixes duplicate policy error)
