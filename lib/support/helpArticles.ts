...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    summary:
      "Record goods or services received from a supplier when payment will be made later. Expense lines go to Expenses, while materials for future use go to Inventory.",
    planNote: "Supplier bills are available on Professional plans and above.",
    steps: [
      "Use a supplier bill when your business receives goods or services now but will pay the supplier later. Recording the bill creates an amount owed under Accounts Payable — it is not the same as an immediate cash expense.",
      "Ordinary operating costs (rent, internet, professional services) are recorded as expense lines. Finza posts them to the expense account you choose and increases what you owe the supplier.",
      "Materials bought for future jobs or direct sales are recorded as inventory (account 1450), not as an immediate expense. They become a cost only when the materials are used on a job or fulfilled to a customer (Dr 5110 Material usage / COGS, Cr 1450 Inventory).",
      "Open Supplier Bills → New Bill. Enter the supplier, bill number, dates, and line items. Save — the bill stays in payables until you record payment.",
      "Recording payment later clears Accounts Payable and reduces your bank or cash balance. Payment does not create the original expense or inventory purchase.",
      "Input taxes and withholding tax (WHT) are tracked separately where applicable. WHT reduces the amount paid to the supplier and creates a WHT payable amount, while the bill may still include inventory or expense lines.",
      "Example: If you buy GH₵500 of materials on credit, Finza records GH₵500 as material inventory and GH₵500 as money owed to the supplier. The material cost moves to Expenses only when the materials are used or fulfilled.",
  ...
  },
  {
    ...
    category: "Expenses & bills",
    tags: ["bill", "pay", "supplier", "payment", "accounts payable"],
    summary:
      "Record payment to clear what you owe on a supplier bill. Payment reduces Accounts Payable and your bank or cash — it does not recreate the bill’s expense or inventory lines.",
    planNote: "Supplier bills are available on Professional plans and above.",
    steps: [
      "Open Supplier Bills and select the bill you paid.",
      "Click Record Payment or Add Payment.",
      "Enter amount, date, and payment method (bank, MoMo, cash).",
      "Save — Finza reduces Accounts Payable and the remaining bill balance. Fully paid bills no longer count toward what you owe suppliers.",
      "Remember: payment clears the amount owed. The original expense or inventory purchase was already recorded when you saved the bill.",
    ],
    relatedLinks: [{ label: "Supplier bills", href: "/service/bills" }],
  },
