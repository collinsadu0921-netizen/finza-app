/**
 * Zambia Tax Engine Implementation
 * 
 * Minimal VAT-only tax engine for Zambia.
 * VAT Rate: 16%
 * 
 * Calculation:
 * - Exclusive: tax = baseAmount * 0.16
 * - Inclusive: base = total / 1.16
 */
 ...
 * Zambia Tax Engine
 */
export const zambiaTaxEngine: TaxEngine = {
