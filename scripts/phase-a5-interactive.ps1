param(
  [switch]$VerifyOnly = $true
)

$ErrorActionPreference = "Stop"

$OutFile = ".\scripts\phase-a5-verify-479-493.sql"
...
Write-Host ""
Write-Host "Open this file and paste it into Supabase SQL Editor on production."
Write-Host "This is verify-only. No repairs. No applies. No db push."
